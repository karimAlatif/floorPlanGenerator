    ...
    <div className="w-1/2 flex flex-col">
      <div className="bg-slate-900 px-4 py-3 border-b border-slate-800 flex-shrink-0">
        ...
        <div className="flex flex-wrap gap-3 items-end">
          ...
          <button
            onClick={resetCamera}
            className="px-3 py-1.5 text-xs font-medium bg-slate-700 hover:bg-slate-600 text-slate-200 rounded-md border border-slate-600 transition-colors duration-150"
          >
            Reset Camera
          </button>
        </div>
      ...
      <div className="relative flex-1 bg-slate-950">
        ...
        {!hasWalls && (
          <p className="absolute inset-0 flex items-center justify-center text-slate-700 text-sm pointer-events-none text-center px-8">
